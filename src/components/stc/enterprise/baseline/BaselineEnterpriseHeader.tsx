...
import { footerColumns, navServices } from "@/data/archive/copy-baseline/nav";
...
export function BaselineEnterpriseHeader() {
  const {
    luxOpen,
    drawerOpen,
    openLux,
    ...
    <>
      <header className="turner-header" id="site-header">
        <div className="container turner-header__inner">
          <Wordmark href={B} className="turner-header__logo" />
          ...
          <nav className="stc-lux-nav" aria-label="Primary">
            ...
            <Link className="stc-lux-nav__link" href={`${B}/about`}>
              About
            </Link>
            <Link className="stc-lux-nav__link" href={`${B}/contact`}>
              Contact
            </Link>
          </nav>

          <div className="turner-header__actions">
            <Link href={`${B}/contact`} className="btn-header-cta">
              Get a Quote
            </Link>
            <button
              type="button"
      ...
      >
          ...
          <div className="stc-lux-panel__inner">
            <div className="stc-lux-panel__grid stc-lux-panel__grid--services">
              ...
              <aside className="stc-lux-panel__feature">
                ...
                <LinkArrow href={`${B}/projects`} className="link-arrow stack-cta" onClick={closeLux}>
                  View project
                </LinkArrow>
              </aside>
            </div>
            <div className="stc-lux-panel__foot">
              <LinkArrow href={`${B}/services`} onClick={closeLux}>
                View all services
              </LinkArrow>
            </div>
          </div>
        ...
        >
          <div className="stc-lux-panel__inner">
            ...
            <div className="stc-lux-panel__foot">
              <LinkArrow href={`${B}/projects`} onClick={closeLux}>
          ...
          <div className="stc-lux-panel__inner">
            <div className="stc-lux-panel__grid stc-lux-panel__grid--company">
              ...
              <div className="stc-lux-panel__col">
                ...
                <LinkArrow href={`${B}/about`} className="stack-cta" onClick={closeLux}>
                  Get to know us
                </LinkArrow>
              </div>
            </div>
      ...
      >
        ...
        <nav className="turner-drawer__nav">
          ...
          <Link href={`${B}/services`} onClick={closeDrawer}>
            All Services
          </Link>
          ...
          <Link href={`${B}/projects`} onClick={closeDrawer}>
            Projects
          </Link>
          <Link href={`${B}/about`} onClick={closeDrawer}>
            About
          </Link>
          <Link href={`${B}/contact`} onClick={closeDrawer}>
            Contact
          </Link>
        </nav>
