...
export function AboutPreview() {
  return (
    <section id="about-preview" className="bg-stc-black text-stc-white">
      <Container>
        <SectionBlock pad="lg">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center lg:gap-16">
            ...
            <div>
              ...
              <h2 className="text-display mt-6">
                Built on <span className="text-stc-gold">Reputation</span>
              </h2>
              <p className="mt-6 font-body text-base leading-relaxed text-stc-white/75">
              ...
              <p className="mt-4 font-body text-base leading-relaxed text-stc-white/75">
              ...
              <ul className="mt-8 flex flex-col gap-4">
                {values.map((v) => (
                  <li key={v.title} className="flex items-center gap-3">
                    ...
                    <span className="font-utility text-sm tracking-wide text-stc-white/70 uppercase">
