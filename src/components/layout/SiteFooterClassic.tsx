...
import { cta, footerColumns } from "@/data/nav";
import { site } from "@/data/site";

const classicCompanyLinks = [
...
/** Pre–mockup-layout footer: black + gold only — no green bar, no watermark. */
export function SiteFooterClassic() {
  return (
