export const conversion = {
  hero: {
    eyebrow: "South Georgian Bay",
    headline: "Building With",
    headlineAccent: "Integrity",
    lead:
      "Premium armour stone, waterfront assemblies, and full-site outdoor construction across Muskoka and South Georgian Bay.",
