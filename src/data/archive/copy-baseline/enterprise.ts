...
import { cta } from "./nav";
import { COPY_BASELINE_PREFIX as B } from "./constants";
...
export const enterpriseCommitments = [
  {
    ...
    cta: { label: "Learn More", href: `${B}/about` },
  ...
  },
  {
    ...
    cta: { label: "See Our Work", href: `${B}/projects` },
  ...
  },
  {
    ...
    cta: { label: "Our Approach", href: `${B}/about` },
  ...
  },
  {
    ...
    cta: { label: "Our Areas", href: `${B}/areas` },
  ...
  },
  {
    ...
    cta: { label: "Explore Services", href: `${B}/services` },
